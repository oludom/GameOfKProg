...
public class MDIWindow extends BorderPane {
     ...
     * @throws Exception
     */
    public MDIWindow(String mdiWindowID, ImageView logoImage, String title, Node content) {
     ...
     * @throws Exception
     */
    public MDIWindow(String mdiWindowID, ImageView logoImage, String title, Node content, boolean disableResize) {
